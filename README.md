...
- **Task screens** — one per task; shows the full navigation tree as a flat bullet list (`•` / `◦`); clicking any item records it as the answer
- Brief visual highlight on selection before advancing to the next task
...
- The tree display shows all nodes expanded; very large trees (100+ nodes) may require scrolling.
